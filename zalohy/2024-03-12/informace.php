...
<head>
    ...
    <title>INFORMACE K NÁBORŮM</title>
</head>
<body>
    ...
    if (($_SESSION["typ"] == "5") or ($_SESSION["typ"] == "1") or ($_SESSION["typ"] == "6"))
    {
        if (isset($_GET["typ"]))
        {
            if ($_GET["typ"] == "updatedata")
            {
                ...
                $dotaz="update nabory set boty='" . $_POST['boty'] . "',obleceni='" . $_POST['obleceni'] . "',telinfo='" . $_POST['telinfo'] . "',nastup='" . date_format($date1,"Y-m-d") . "',smena='" . $_POST['smena'] . "',nastupmisto='" . $_POST['nastupmisto'] . "' where id='" . $_POST['idnabor'] . "'"; 
        ...
        ?>
            ...
            <h3 class="text-center m-2 p-2">Informace k náborům</h3>
            ...
            <?php  
                ...
                $sql = "select nabory.id,prijmeni,jmeno,telefon,adresa,dat_narozeni,stat,dat_evidence,zdroj_inzerce,pozice,klient,klient2,souhlas,rekruter,vysledek,nastup,vystup,koordinator,poznamka,boty,obleceni,telinfo,nastupmisto,zastavka from nabory left join zastavky on nabory.nastupmisto = zastavky.id where vysledek='Přijat' order by dat_evidence desc";
                ...
                {                                        
                    ...
                    <tr>
                        ...
                        <td class='text-center'><?php echo $radek["klient"];?></td>
