...
if (kontrola_prihlaseni() == "OK")
{
    if (isset($_SESSION["typ"]))
    {
        if ($_SESSION["typ"] == "5")
        {
            ...
            $dotaz = "SELECT DISTINCT(zamestnanci.cilova) from dochazka left join firmy on dochazka.firma = firmy.id left join zamestnanci on dochazka.zamestnanec = zamestnanci.id where datum between '" . $start_day . "' and '" . $end_day . "' and zamestnanci.cilova<>'' order by zamestnanci.cilova";
