...
{   
    if (isset($_GET["typ"]))
    {
        if (($_GET["typ"] == "novyzamestnanec" and $_SESSION["typ"] == "1") or ($_GET["typ"] == "novyzamestnanec" and $_SESSION["typ"] == "4") or ($_GET["typ"] == "novyzamestnanec" and $_SESSION["typ"] == "5"))
        {   ?>
            
            <h3 class="text-center m-2 p-2">Přidání nového zaměstnance</h3>
            ...
            <div class="container">
                ...
                <div class="col-md-3 mt-5">
                    ...
                    <input type="text" class="form-control" id="prijmeni" name="prijmeni" placeholder="" value="" required>
                ...
                <div class="col-md-3 mt-5">
                    <div class="form-floating">
                    <input type="text" class="form-control" id="jmeno" name="jmeno" placeholder="" value="" required>
                ...
                <div class="col-md-2 mt-5">
                    <div class="form-floating">
                    <input type="text" class="form-control" id="oscislo" name="oscislo" placeholder="" value="" required>
                ...
                <div class="col-md-4 mt-5">
                    <div class="form-floating">
                    <input type="text" class="form-control" id="adresa" name="adresa" placeholder="" value="" required>
                ...
                <div class="col-md-4 mt-5">
                    <div class="form-floating">
                    <input type="text" class="form-control" id="rfid" name="rfid" placeholder="" value="" required>
                ...
                <div class="col-md-4 mt-5">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="datepicker" name="datepicker"  placeholder="Vyber datum" value="<?php echo date("d.m.Y");?>" required>
                ...
                <div class="col-md-4 mt-5">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="datepicker2" name="datepicker2"  placeholder="Vyber datum" value="31.12.2023">
                ...
                <div class="col-md-2 mt-5">
                    <div class="form-floating">
                    <input type="text" class="form-control" id="cilova" name="cilova" placeholder="" value="">
                    <label for="floatingInputGrid">Cílová stanice</label>
                    </div>
                </div>
      
                <div class="row g-2 mt-2 mt-5">
                    <button type="submit" class="btn btn-primary btn-block">Vložit zaměstnance do databáze</button>
                </div>
        ...
        elseif (($_GET["typ"] == "savezamestnance" and $_SESSION["typ"] == "1") or ($_GET["typ"] == "savezamestnance" and $_SESSION["typ"] == "4") or ($_GET["typ"] == "savezamestnance" and $_SESSION["typ"] == "5"))
        {
            $date1=date_create($_POST["datepicker"]);
            $date2=date_create($_POST["datepicker2"]);

            $sql= "insert into zamestnanci (os_cislo,prijmeni,jmeno,rfid,nastup,telefon,adresa,firma,smena,aktivni,nepritomnost,smena2,cilova,vstup,vystup) values ('" . $_POST["oscislo"] . "','" . $_POST["prijmeni"] . "','" . $_POST["jmeno"] . "','" . $_POST["rfid"] . "','" . $_POST["nastup"] . "','" . $_POST["telefon"] . "','" . $_POST["adresa"] . "','" . $_POST["firma"] . "','" . $_POST["smena"] . "','1','" . $_POST["nepritomnost"] . "','" . $_POST["smena2"] . "','" . $_POST["cilova"] . "','" . date_format($date1,"Y-m-d") . "','" . date_format($date2,"Y-m-d") . "')"; 
            ...
            <?php
                ...
                {   
                    ...
                    ?>
                        ...
                        if (($_SESSION['typ'] == 1) or ($_SESSION['typ'] == 4) or ($_SESSION['typ'] == 5))
                        {   ?>
                                <td><a type="button" class="btn btn-outline-primary" href="zamestnanci.php?typ=editzam&id=<?php echo $radek["id"];?>">Edit</button></a></td>
                            <?php
                        }
                        ?>                    
                    </tr>
    ...
    {   ?>
        ...
        {   
            ...
            {   ?>
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a class="btn btn-outline-primary text-center m-2" href="zamestnanci.php?typ=novyzamestnanec" role="button">Nový zaměstnanec</a>
