            ...
            if (isset($_SESSION["logged"]))
            {
                ...
                {   ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                            <li class="nav-item"><a class="dropdown-item text-danger" href="#">Přehled firem (překlápění směn)</a></li>
                        </li>

                        <li class="nav-item">
                            <li class="nav-item"><a class="dropdown-item text-danger" href="#">Kontrola DPN</a></li>
                        </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                            <li class="nav-item"><a class="dropdown-item text-danger" href="#">Informace k nástupům</a></li>
                        </li>
...
{    
    ...
    if ($id <> '')
    {
        ...
        <form name="firma_new" method="POST" action="main.php?typ=updatefirma">
    ...
    {   ?>
        ...
        <form name="firma_new" method="POST" action="main.php?typ=vytvorfirmu">
