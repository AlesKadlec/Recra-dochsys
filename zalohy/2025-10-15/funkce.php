...
function insert_attandance_manually($id_emp,$bus,$zastavka,$firma,$smena,$datum,$cas,$nepritomnost) 
{
    ...
    {
      $dotaz="insert into dochazka (zamestnanec,datum,cas,smena,bus,firma,zastavka,ip,cron,nepritomnost) values ('" . $id_emp . "','" . $datum . "','" . $cas . "','" . $smena . "','" . $bus . "','" . $firma . "','" . $zastavka . "','" . $_SERVER['REMOTE_ADDR'] . "','2','" . $nepritomnost . "')"; 
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select bg-primary-subtle" name="zdroj" id="zdroj" required>
                            <?php
                                ...
                                echo (isset($polehodnot) && $polehodnot[0]['zdroj_inzerce'] == 'Náborový leták' && $id <> '') ? "<option value='Náborový leták' class='bg-primary-subtle' selected>Náborový leták</option>" : "<option value='Náborový leták' class='bg-primary-subtle'>Náborový leták</option>";
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select bg-primary-subtle" name="klient" id="klient" required>
                            <?php
                                ...
                                echo (isset($polehodnot) && $polehodnot[0]['klient'] == 'ALLIANCE LAUNDRY' && $id <> '') ? "<option value='ALLIANCE LAUNDRY' class='bg-primary-subtle' selected>ALLIANCE LAUNDRY</option>" : "<option value='ALLIANCE LAUNDRY' class='bg-primary-subtle'>ALLIANCE LAUNDRY</option>";
                                ...
                                echo (isset($polehodnot) && $polehodnot[0]['klient'] == 'THERMA' && $id <> '') ? "<option value='THERMA' class='bg-primary-subtle' selected>THERMA</option>" : "<option value='THERMA' class='bg-primary-subtle'>THERMA</option>";
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select bg-primary-subtle" name="vysledek" id="vysledek" required>
                            <?php
                                ...
                                echo (isset($polehodnot) && $polehodnot[0]['vysledek'] == 'Emergency' && $id <> '') ? "<option value='Emergency' class='bg-primary-subtle' selected>Emergency</option>" : "<option value='Emergency' class='bg-primary-subtle'>Emergency</option>";
                            ?>
                        </select>
                    </div>
...
{    
    ...
    $sql = "select id,os_cislo,os_cislo_klient,prijmeni,jmeno,rfid,nastup,telefon,adresa,firma,smena,aktivni,nepritomnost,smena2,cilova,vstup,vystup,anulace,radneukoncen,dpn_od,smennost from zamestnanci where id='" . $id . "'";
    ...
    {  
        ...
        $os_cislo_kl = $radek["os_cislo_klient"];
        $rfid = $radek["rfid"];
        $nastup = $radek["nastup"];
                ...
                <div class="container">           
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select bg-primary-subtle" id="nepritomnost" name="nepritomnost" aria-label="Floating label select example">
                                ...
                                echo (isset($nepritomnost) && $nepritomnost == 'OČR') ? "<option value='OČR' class='bg-primary-subtle' selected>OČR</option>" : "<option value='OČR' class='bg-primary-subtle'>OČR</option>";
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <label for="floatingSelect">Směnnost</label>
                            <select class="form-select bg-primary-subtle" id="smennost" name="smennost" aria-label="Floating label select example">
                                <?php
                                echo (isset($smennost) && $smennost == '3SM') ? "<option value='3SM' class='bg-primary-subtle' selected>3SM</option>" : "<option value='3SM' class='bg-primary-subtle'>3SM</option>";
                                echo (isset($smennost) && $smennost == '4SM A') ? "<option value='4SM A' class='bg-primary-subtle' selected>4SM A</option>" : "<option value='4SM A' class='bg-primary-subtle'>4SM A</option>";
                                echo (isset($smennost) && $smennost == '4SM B') ? "<option value='4SM B' class='bg-primary-subtle' selected>4SM B</option>" : "<option value='4SM B' class='bg-primary-subtle'>4SM B</option>";
                                echo (isset($smennost) && $smennost == '4SM C') ? "<option value='4SM C' class='bg-primary-subtle' selected>4SM C</option>" : "<option value='4SM C' class='bg-primary-subtle'>4SM C</option>";
                                echo (isset($smennost) && $smennost == '4SM D') ? "<option value='4SM D' class='bg-primary-subtle' selected>4SM D</option>" : "<option value='4SM D' class='bg-primary-subtle'>4SM D</option>";
                                ?>
                            </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table">
                                    ...
                                    for ($day = 1; $day <= $daysInMonth; $day++)
                                        {
                                            ...
                                            $smena = kontrola_dochazky($id_zam,$year . "-" . $month . "-" . $day);
                                            
                                            ?>                                                

                                            <input type="hidden" id="lasttoggle<?php echo $day; ?>" name="lasttoggle<?php echo $day; ?>" value="<?php echo $smena;?>">
                                            <select class="form-select bg-primary-subtle text-center fw-bold fs-5" name="toggle<?php echo $day; ?>" id="toggle<?php echo $day; ?>">

                                                <?php                                         
    
                                                echo (isset($smena) && $smena == 'R') ? "<option value='R' class='bg-primary-subtle' selected>R</option>" : "<option value='R' class='bg-primary-subtle'>R</option>";
                                                echo (isset($smena) && $smena == 'O') ? "<option value='O' class='bg-primary-subtle' selected>O</option>" : "<option value='O' class='bg-primary-subtle'>O</option>";
                                                echo (isset($smena) && $smena == 'N') ? "<option value='N' class='bg-primary-subtle' selected>N</option>" : "<option value='N' class='bg-primary-subtle'>N</option>";

                                                echo (isset($smena) && $smena == 'NN') ? "<option value='NN' class='bg-primary-subtle' selected>NN</option>" : "<option value='NN' class='bg-primary-subtle'>NN</option>";
                                                echo (isset($smena) && $smena == 'NR') ? "<option value='NR' class='bg-primary-subtle' selected>NR</option>" : "<option value='NR' class='bg-primary-subtle'>NR</option>";

                                                echo (isset($smena) && $smena == 'DPN') ? "<option value='DPN' class='bg-warning-subtle' selected>DPN</option>" : "<option value='DPN' class='bg-warning-subtle'>DPN</option>";
                                                echo (isset($smena) && $smena == 'OČR') ? "<option value='OČR' class='bg-warning-subtle' selected>OČR</option>" : "<option value='OČR' class='bg-warning-subtle'>OČR</option>";
                                                echo (isset($smena) && $smena == 'ABS') ? "<option value='ABS' class='bg-warning-subtle' selected>ABS</option>" : "<option value='ABS' class='bg-warning-subtle'>ABS</option>";
                                                echo (isset($smena) && $smena == 'LEK') ? "<option value='LEK' class='bg-warning-subtle' selected>LEK</option>" : "<option value='LEK' class='bg-warning-subtle'>LEK</option>";
                                                echo (isset($smena) && $smena == 'DOV') ? "<option value='DOV' class='bg-success-subtle' selected>DOV</option>" : "<option value='DOV' class='bg-success-subtle'>DOV</option>";
                                                echo (isset($smena) && $smena == 'OABS') ? "<option value='OABS' class='bg-success-subtle' selected>OABS</option>" : "<option value='OABS' class='bg-success-subtle'>OABS</option>";
                                                echo (isset($smena) && $smena == 'NAHV') ? "<option value='NAHV' class='bg-success-subtle' selected>NAHV</option>" : "<option value='NAHV' class='bg-success-subtle'>NAHV</option>";
                                                echo (isset($smena) && $smena == 'NEPV') ? "<option value='NEPV' class='bg-success-subtle' selected>NEPV</option>" : "<option value='NEPV' class='bg-success-subtle'>NEPV</option>";

                                                echo (isset($smena) && $smena == '') ? "<option value='' class='bg-primary-subtle' selected>N/A</option>" : "<option value='' class='bg-primary-subtle'>N/A</option>";
                                        
                                                ?>

                                                <?php
                                                    //echo (isset($smena) && $smena == '') ? "<option value='' class='bg-primary-subtle' selected>Bez záznamu</option>" : "<option value='' class='bg-primary-subtle'>Bez záznamu</option>";    
                                                ?>
                                            </select>
                        ...
                        <input type="hidden" id="vybrany_mesic" name="vybrany_mesic" value="<?php echo $month;?>">
                        <input type="hidden" id="vybrany_rok" name="vybrany_rok" value="<?php echo $year;?>">
                        <input type="hidden" id="max_den" name="max_den" value="<?php echo $daysInMonth;?>">
                        <input type="hidden" id="id_zam" name="id_zam" value="<?php echo $id_zam;?>">
