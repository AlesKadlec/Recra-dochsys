    ...
    if (($_SESSION["typ"] == "5") or ($_SESSION["typ"] == "1"))
    {
        ...
        ?>
            ...
            <?php  
                ...
                $sql = "select kontroly.id,id_zam,kontroly.dpn_od,kontroly.dpn_do,kontrola,kontrolacas,zadal,provedl,vysledek,kontroly.adresa,jmeno,prijmeni,cilova from kontroly left join zamestnanci on kontroly.id_zam = zamestnanci.id order by kontrola desc, kontrolacas desc";
