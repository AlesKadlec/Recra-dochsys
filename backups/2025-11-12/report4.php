                        ...
                        )
                        {
                            ...
                            if (in_array($_POST['toggle' . $i], $nepritomnosti_toggle)) 
                            {
                                ...
                                {                           
                                    ...
                                    // poznámka pro daný den (z hidden inputu)
                                    $poznamka_dne = $_POST['poznamka' . $i] ?? '';

                                    insert_attandance_manually($_POST['id_zam'],$auto,$zastavka,$firma,$smena,$_POST['vybrany_rok'] . "-" . $_POST['vybrany_mesic'] . "-" . $i,$cas_nastupu,$array3[$i],$poznamka_dne);
                            ...
                            else
                            {
                                ...
                                insert_attandance_manually($_POST['id_zam'],$auto,$zastavka,$firma,$_POST['toggle' . $i],$_POST['vybrany_rok'] . "-" . $_POST['vybrany_mesic'] . "-" . $i,$cas_nastupu,'',$poznamka_dne);
