    ...
    if (isset($_SESSION["typ"]))
    {
        if (($_SESSION["typ"] == "5") or ($_SESSION["typ"] == "1") or ($_SESSION["typ"] == "4"))
        {
            ...
            if (!empty($_POST['mesic'])) {
                ...
                // fallback kdybys někde posílal jen hidden
                $vybranyMesic = $_POST['hid_mesic'];
            }

            // rozpad na rok a měsíc, aby zbytek skriptu fungoval beze změn
            ...
            $nepritomnosti_other = ['DOV','NAR','NEM','NEO','NEP','PRO','NEPV','NAHV','SVA'];
