...
<!--                         <div class="col-md-2">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            <label for="cilova">Cílová stanice</label>
                            <select class="form-select bg-primary-subtle" id="cilova" name="cilova">
                                <option value="">— nevybráno —</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="kalendar" method="POST" action="report4.php?typ=savechange">
                            ...
                            $nepritomnosti_other = ['DOV','NAR','PRO','NEPV','NAHV','SVA'];
                            $tydenni_smeny = ['R','O','N'];
