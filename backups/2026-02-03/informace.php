    ...
    if (($_SESSION["typ"] == "5") or ($_SESSION["typ"] == "1") or ($_SESSION["typ"] == "6"))
    {
        ...
        ?>
            ...
            <?php  
                ...
                $sql = "select nabory.id,prijmeni,jmeno,telefon,adresa,dat_narozeni,stat,dat_evidence,zdroj_inzerce,pozice,klient,klient2,souhlas,rekruter,vysledek,nastup,vystup,koordinator,poznamka,boty,obleceni,telinfo,nastupmisto,zastavka,smena,firmy.firma,oscislo from nabory left join zastavky on nabory.nastupmisto = zastavky.id left join firmy on nabory.firma = firmy.id where vysledek='Přijat' order by dat_evidence desc";
