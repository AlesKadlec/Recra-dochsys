...
if (kontrola_prihlaseni() == "OK")
{
    if (isset($_SESSION["typ"]))
    {
        ...
        // výchozí směna
        $smena = isset($_GET['smena']) && in_array($_GET['smena'], ['R','O','N','X','CH']) ? $_GET['smena'] : 'R';
        ?>
        ...
        <div id="tableScrollContainer" class="container-fluid mt-3">
            <table id="planTable" class="table table-hover table-striped table-sm align-middle"
                ...
                if ($smenaFilter === 'CH') {
                    ...
                    $sql = "SELECT z.jmeno, z.prijmeni, f.firma, z.cilova, n.zastavka, a.spz
                            FROM zamestnanci z
                            ...
                            LEFT JOIN auta a ON p.trasa = a.id
                            WHERE (p.jmeno IS NULL OR p.trasa = 0)
                            AND DATE(z.vstup) <= ?
