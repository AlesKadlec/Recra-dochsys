            ...
            <div class="modal-body">
                ...
                <div class="container">           
                    ...
                    <div class="row mt-3">               
                        ...
                        <div class="col-md-2">
                            <label for="datepicker2">Výstup</label>
                            <input type="text" class="form-control bg-primary-subtle datepicker" id="datepicker2" name="datepicker2" placeholder="Vyber datum" value="<?php echo date_format($vystup,'d.m.Y');?>">
                        </div>

                        <div class="col-md-2">
                            <label for="datepicker3">Anulace</label>
                            <input type="text" class="form-control bg-primary-subtle datepicker" id="datepicker3" name="datepicker3" placeholder="Vyber datum" value="<?php echo date_format($anulace,'d.m.Y');?>">
                        </div>
                    ...
                    <form name="kalendar" method="POST" action="report4.php?typ=savechange">
                        <table class="table text-center align-middle">
                            ...
                            <tbody>
                                ...
                                for ($i = $weekDay; $i > 1; $i--) echo '<td>&nbsp;</td>';
                                ...
                                for ($day = 1; $day <= $daysInMonth; $day++) {
                                    ...
                                    // barva buňky
                                    if ($je_vikend) {
                                        $barva = 'bg-warning-subtle';
                                    } elseif ($smena === '') {
                                        $barva = 'bg-danger-subtle';
                                    } else {
                                        $barva = 'bg-primary-subtle';
                                    }
                                    ?>
                                    <td class="text-center <?php echo $barva; ?>">
                                        <label class="form-label fw-bold fs-3 <?php if($je_vikend) echo 'text-danger'; ?>"><?php echo $day; ?></label>
                                        ...
                                        <select class="form-select text-center fw-bold fs-5" name="toggle<?php echo $day; ?>" id="toggle<?php echo $day; ?>">
                                            <?php
                                            // N/A
                                            echo ($smena === '') ? "<option value='' selected>N/A</option>" : "<option value=''>N/A</option>";

                                            // ostatní možnosti
                                            $options = ['R','O','N','NN','NR','DPN','OČR','ABS','LEK','DOV','OABS','NAHV','NEPV'];
                                            foreach ($options as $opt) {
                                                $opt_class = in_array($opt,['DPN','OČR','ABS','LEK']) ? 'bg-warning-subtle' : (in_array($opt,['DOV','OABS','NAHV','NEPV']) ? 'bg-success-subtle' : 'bg-primary-subtle');
                                                $selected = ($smena === $opt) ? 'selected' : '';
                                                echo "<option value='$opt' class='$opt_class' $selected>$opt</option>";
                                            }
                                            ?>
                                        </select>
                                    </td>
                                    ...
                                    $den_v_tydnu++;
                                    if ($den_v_tydnu > 7) $den_v_tydnu = 1;
                                }
                                ?>
                                </tr>
                            </tbody>
