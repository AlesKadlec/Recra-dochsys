    ...
    if (($_SESSION["typ"] == "5") or ($_SESSION["typ"] == "1") or ($_SESSION["typ"] == "6"))
    {
        if (isset($_GET["typ"]))
        {
            if ($_GET["typ"] == "updatedata")
            {
                ...
                $dotaz="update nabory set boty='" . $_POST['boty'] . "',obleceni='" . $_POST['obleceni'] . "',telinfo='" . $_POST['telinfo'] . "',nastup='" . date_format($date1,"Y-m-d") . "',smena='" . $_POST['smena'] . "',nastupmisto='" . $_POST['nastupmisto'] . "',firma='" . $_POST['firma'] . "',cilova='" . $_POST['cilova'] . "' where id='" . $_POST['idnabor'] . "'"; 
        ...
        ?>
            ...
            <?php  
                ...
                $sql = "select nabory.id,prijmeni,jmeno,telefon,adresa,dat_narozeni,stat,dat_evidence,zdroj_inzerce,pozice,klient,klient2,souhlas,rekruter,vysledek,nastup,vystup,koordinator,poznamka,boty,obleceni,telinfo,nastupmisto,zastavka,smena,firmy.firma from nabory left join zastavky on nabory.nastupmisto = zastavky.id left join firmy on nabory.firma = firmy.id where vysledek='Přijat' order by dat_evidence desc";
